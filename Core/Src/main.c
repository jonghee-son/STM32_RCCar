...
uint8_t tx_data1[NRF24L01P_PAYLOAD_LENGTH] = {1,};
uint8_t tx_data2[NRF24L01P_PAYLOAD_LENGTH] = {7,};
uint8_t tx_data3[NRF24L01P_PAYLOAD_LENGTH] = {3,};
uint8_t tx_data4[NRF24L01P_PAYLOAD_LENGTH] = {15,};
uint8_t tx_data5[NRF24L01P_PAYLOAD_LENGTH] = {0,};
/* USER CODE END PV */
